package com.multitech.skydailer.constantvalues.logentry.logadapter;
...
import com.multitech.skydailer.constantvalues.logentry.LogEntryCache;
...
public class LogEntryAdapter extends CursorAdapter implements View.OnClickListener
{
	...
	public LogEntryAdapter(MainActivity activity, Cursor cursor, AsyncContactImageLoader loader) {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		viewCache.contactImage.setTag(phoneNumber); // set a tag for the callback to be able to check, so we don't set the contact image of a reused com.example.constantValues.view
		Drawable d = mAsyncContactImageLoader.loadDrawableForNumber(phoneNumber, new AsyncContactImageLoader.ImageCallback() {
