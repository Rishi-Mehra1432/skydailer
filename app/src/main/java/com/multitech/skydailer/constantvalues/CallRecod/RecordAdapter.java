...
//                    intent.setDataAndType(Uri.fromFile(file), "audio/*");
                    ...
                    intent.setDataAndType(getUriForFile(context,"com.multitech.callrecorder",file), "audio/*");
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            /*case 1:
                ...
                break;*/
            case 2:
                View v3 = layoutInflator.inflate(R.layout.date_record_layout, parent, false);
                viewHolder = new MyViewHolder(v3);
                break;
            /*case 3:
                View v4 = layoutInflator.inflate(R.layout.date_noname_record_layout, parent, false);
